...
var subaddressAddressBase58Prefix = config.poolServer.subAddressPrefix ? parseInt(config.poolServer.subAddressPrefix) : addressBase58Prefix + 2;
...
exports.validateMinerAddress = function(address) {
    ...
    else if (addressPrefix === subaddressAddressBase58Prefix) return true;
    return false;
}
